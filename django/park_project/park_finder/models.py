...
class User(models.Model):
    ...
    current_hiking_group = models.CharField(max_length=255, default = None)
...
class Park(models.Model):
    ...
    permitted_activities = models.CharField(max_length=255) #?is this the best way for a checklist-style form input?
    natural_features = models.CharField(max_length=255) #? same as above
...
class Visit(models.Model):
    ...
    hiking_group_at_visit_time = models.CharField(max_length=255, default = None)
